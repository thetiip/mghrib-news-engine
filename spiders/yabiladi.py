...
class YabiladiSpider(BaseSpider):
    """Spider for Yabiladi news site."""

    def __init__(self):
        """Initialize Yabiladi spider."""
        super().__init__("Yabiladi")
        self.rss_url = "https://www.yabiladi.com/rss/"
        self.base_url = "https://www.yabiladi.com"
        self.rss_entries = {}
    ...
    def get_article_urls(self, max_articles: int = 50) -> List[str]:
        ...
        try:
            ...
            logger.error(f"Error fetching Yabiladi URLs: {str(e)}")
            return []
    ...
    def get_category(self, article_soup: Optional[BeautifulSoup], url: str) -> Optional[str]:
        ...
        if article_soup:
            ...
            breadcrumb = article_soup.find('div', class_='breadcrumb') or article_soup.find('nav', class_='breadcrumb')
            if breadcrumb:
        ...
        if 'politique' in url_lower:
            return "Politique"
        elif 'economie' in url_lower:
            return "Économie"
        elif 'sport' in url_lower:
            return "Sport"
        elif 'societe' in url_lower or 'society' in url_lower:
            return "Société"
        elif 'culture' in url_lower:
            return "Culture"
        elif 'diaspora' in url_lower or 'mre' in url_lower:
            return "Diaspora"
    ...
    def parse_article(self, url: str) -> Optional[Dict]:
        """Parse a single Yabiladi article."""
        # Try RSS entry first
        ...
        try:
            ...
            logger.error(f"Error parsing Yabiladi article {url}: {str(e)}")
            return None
